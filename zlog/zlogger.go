...
func NewZinxLog(out io.Writer, prefix string, flag int) *ZinxLogger {
	// fmt.Println("==========>BitDate: ", BitDate, "BitTime: ", BitTime, "BitMicroSeconds: ", BitMicroSeconds, "BitLongFile: ", BitLongFile, "BitShortFile: ", BitShortFile, "BitLevel: ", BitLevel, "BitStdFlag: ", BitStdFlag, "BitDefault: ", BitDefault)
